...
namespace Tween
{
    ...
    public class CustomButton : Button
    {
        ...
        [SerializeField]
        private ButtonAnimationType _animationButtonType = ButtonAnimationType.ShakePosition;
        ...
        {
            CentralizedAudioSource.Instance.PlaySoundClip(_audioSource.clip);
        }
